...
export function ProfilePage() {
  ...
  const { data, isEmailAdmin, isDeedLigEditor } = useStore()
  ...
  const canOpenAdmin = isEmailAdmin(user.email) || isDeedLigEditor(user.email)
  const isDeedLigEditorOnly = isDeedLigEditor(user.email) && !isEmailAdmin(user.email)
          ...
          <div className="prof-chips">
            ...
            {canOpenAdmin ? (
              <span className="prof-chip prof-chip-admin">
                {isDeedLigEditorOnly ? 'Дээд Лиг Editor' : 'Admin'}
              </span>
            ) : null}
          </div>
          {(memberUntil || joined) && (
          ...
          {canOpenAdmin && (
            <li>
              <Link to="/admin" className="prof-menu-item prof-menu-item-admin">
                ...
                <span className="prof-menu-text">
                  <strong>{isDeedLigEditorOnly ? 'Дээд Лиг мэдээ' : 'Admin panel'}</strong>
                  <em>
                    {isDeedLigEditorOnly
                      ? 'Мэдээ нэмэх · засах · устгах'
                      : 'Контент · CMS · тохиргоо'}
                  </em>
                </span>
                <span className="prof-chevron" aria-hidden="true">
                  ›
